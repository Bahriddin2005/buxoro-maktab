...
urlpatterns = [
    ...
    path('<int:test_id>/upload-questions-word/', views.upload_questions_from_word, name='upload_questions_word'),
    path('download-word-template/', views.download_word_template, name='download_word_template'),
    path('word-import-guide/', views.word_import_guide, name='word_import_guide'),
    path('students-test-results/', views.students_test_results_view, name='students_test_results'),
    path('students-test-results/export/', views.export_students_test_results_view, name='export_students_test_results'),
