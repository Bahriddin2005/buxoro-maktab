...
if User and hasattr(User, 'role'):
    ...
    class CustomUserAdmin(UserAdmin):
        ...
        export_teachers_credentials.short_description = "📥 O'qituvchilar login va parollarini yuklab olish (Barcha)"
        export_students_credentials.short_description = "📥 O'quvchilar login va parollarini yuklab olish (Barcha)"
